...
% Options ----------------------------------------------------------------
casePath = '../CHARLES/single_family/R4';
...
for i=1:length(probes)
    plot(probes{i}.meanU, y{i}, '-', 'linewidth', 1, 'displayname', probeNames{i})
end
if i>1
    legend
end
...
for i=1:length(probes)
    plot(probes{i}.Lx, y{i}, '-', 'linewidth', 1, 'displayname', probeNames{i})
end
...
for i=1:length(probes)
    plot(probes{i}.Ly, y{i}, '-', 'linewidth', 1, 'displayname', probeNames{i})
end
...
for i=1:length(probes)
    plot(probes{i}.Lz, y{i}, '-', 'linewidth', 1, 'displayname', probeNames{i})
end
...
for j=1:6
    ...
    for i=1:length(probeNames)
        plot(Re_stresses{i}{j}, y{i}, lineSpec{i}, 'linewidth', 1, 'displayname', probeNames{i})
    end
...
for i=1:length(probeNames)
    plot(probes{i}.freq, probes{i}.Euu(:,idx), 'linewidth', 0.8, 'displayname', probeNames{i})
...
for i=1:length(probeNames)
    subplot(1,3,1); hold on
    plot(probes{i}.Iu_avg, y{i}, 'linewidth', 1, 'displayname', probeNames{i})
    xlabel('I_u')
    ylabel('y [m]')
    set(gca, 'fontsize', 14)
    
    subplot(1,3,2); hold on
    plot(probes{i}.Iv_avg, y{i}, 'linewidth', 1, 'displayname', probeNames{i})
    xlabel('I_v')
    set(gca, 'fontsize', 14)
    
    subplot(1,3,3); hold on
    plot(probes{i}.Iw_avg, y{i}, 'linewidth', 1, 'displayname', probeNames{i})
    xlabel('I_w')
    legend
    set(gca, 'fontsize', 14)
end
...
for i=1:length(probes)
    plot(prms{i}, y{i}, '-', 'linewidth', 1, 'displayname', probeNames{i})
end
if i>1
    legend
end
